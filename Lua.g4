...
nempty_list_of_elseif
	...
	var_0__1 = elseif { 
                $result = new List<if_elseif> { _localctx.var_0__1.result };
            }
...
allow_empty_list_of_elseif
	...
	| var_1__1 = nempty_list_of_elseif { 
                $result = _localctx.var_1__1.result;
            };
list_of_elseif
	returns[List<if_elseif> result]:
	var_0__1 = allow_empty_list_of_elseif { 
                $result = _localctx.var_0__1.result;
            };
optional_else
	returns[maybe<if_else> result]:
	var_0__1 = else__x_ { 
                $result = some<if_else>(_localctx.var_0__1.result);
            }
	| { 
                $result = none<if_else>();
            };
stat
	...
	| var_12__1 = 'local' 'function' var_12__3 = NAME '(' var_12__5 = opt_o_parlist_p_ ')' var_12__7
		= block 'end' { 
                $result = new ExprStmt(new FuncDef(_localctx.var_12__1, true, some<IToken>(_localctx.var_12__3), _localctx.var_12__5.result, _localctx.var_12__7.result));
            }
...
opt_assign_rhs
	...
	'=' var_0__2 = nonempty_seplist_of_comma_and_exp { 
                $result = some<List<expr>>(_localctx.var_0__2.result);
            }
	| { 
...
range_tail
	...
	',' var_0__2 = exp { 
                $result = some<expr>(_localctx.var_0__2.result);
            }
	| { 
                $result = none<expr>();
            };
...
else__x_
	...
	var_0__1 = 'else' var_0__2 = block { 
                $result = new if_else(_localctx.var_0__1, _localctx.var_0__2.result);
            };
exp
	returns[expr result]:
	var_0__1 = binexp { 
...
binexp
	returns[expr result]:
	var_0__1 = binseq { 
                $result = mkBinOpSeq(_localctx.var_0__1.result, (op, l, r) => new Bin(op, l, r), ops => new UnsolvedBin(ops));
            };
binseq
	...
	| var_1__1 = binoperand { 
                $result = new List<Op<expr>> { _localctx.var_1__1.result };
            };
binoperand
	returns[Op<expr> result]:
	var_0__1 = unaryexp { 
                $result = mkOperand(_localctx.var_0__1.result);
            };
unaryexp
	returns[expr result]:
	var_0__1 = '#' var_0__2 = exponent { 
                $result = new Len(_localctx.var_0__1, _localctx.var_0__2.result);
            }
	| var_1__1 = '-' var_1__2 = exponent { 
                $result = new Neg(_localctx.var_1__1, _localctx.var_1__2.result);
            }
	| var_2__1 = '~' var_2__2 = exponent { 
                $result = new Inv(_localctx.var_2__1, _localctx.var_2__2.result);
            }
	| var_3__1 = 'not' var_3__2 = exponent { 
                $result = new Not(_localctx.var_3__1, _localctx.var_3__2.result);
            }
	| var_4__1 = exponent { 
...
exponent
	...
	var_0__1 = prefixexp '^' var_0__3 = exponent { 
                $result = new Exponent(_localctx.var_0__1.result, _localctx.var_0__3.result);
            }
	| var_1__1 = prefixexp { 
                $result = _localctx.var_1__1.result;
            };
prefixexp
	returns[expr result]:
	var_0__1 = NAME { 
                $result = new Var(_localctx.var_0__1);
            }
	| var_1__1 = '(' var_1__2 = exp ')' { 
                $result = new NestedExp(_localctx.var_1__1, _localctx.var_1__2.result);
            }
	| var_2__1 = prefixexp var_2__2 = args { 
                $result = new CallFunc(_localctx.var_2__1.result, _localctx.var_2__2.result);
            }
	...
	| var_4__1 = prefixexp '[' var_4__3 = exp ']' { 
                $result = new Index(_localctx.var_4__1.result, _localctx.var_4__3.result);
            }
	| var_5__1 = prefixexp '.' var_5__3 = NAME { 
                $result = new Attr(_localctx.var_5__1.result, _localctx.var_5__3);
            }
	| var_6__1 = atom { 
...
atom
	returns[expr result]:
	var_0__1 = 'nil' { 
                $result = new Nil(_localctx.var_0__1);
            }
	| var_1__1 = 'false' { 
                $result = new Bool(_localctx.var_1__1, false);
            }
	| var_2__1 = 'true' { 
                $result = new Bool(_localctx.var_2__1, true);
            }
	| var_3__1 = NUMERAL { 
                $result = new Num(_localctx.var_3__1);
            }
	| var_4__1 = STR_LIT { 
                $result = new String(_localctx.var_4__1);
            }
	| var_5__1 = '...' { 
                $result = new Ellipse(_localctx.var_5__1);
            }
	| var_6__1 = functiondef { 
                $result = _localctx.var_6__1.result;
            }
	| var_7__1 = tableconstructor { 
                $result = new TableExpr(_localctx.var_7__1.result);
            };
nonempty_seplist_of_comma_and_exp
	returns[List<expr> result]:
	var_0__1 = exp { 
                $result = new List<expr> { _localctx.var_0__1.result };
            }
...
allow_empty_o_nonempty_seplist_of_comma_and_exp_p_
	...
	| var_1__1 = nonempty_seplist_of_comma_and_exp { 
                $result = _localctx.var_1__1.result;
            };
seplist_o__i__s__i__s_exp_p_
	returns[List<expr> result]:
	var_0__1 = allow_empty_o_nonempty_seplist_of_comma_and_exp_p_ { 
                $result = _localctx.var_0__1.result;
            };
args
	...
	| var_1__1 = tableconstructor { 
                $result = new TableArgs(_localctx.var_1__1.result);
            }
	| var_2__1 = STR_LIT { 
                $result = new StringArg(_localctx.var_2__1);
            };
opt_o__i_name_k__p_
	returns[maybe<IToken> result]:
	var_0__1 = NAME { 
                $result = some<IToken>((IToken) _localctx.var_0__1);
            }
	| { 
                $result = none<IToken>();
            };
opt_o_parlist_p_
	...
	var_0__1 = parlist { 
                $result = some<parameters>(_localctx.var_0__1.result);
            }
	| { 
...
functiondef
	returns[expr result]:
	var_0__1 = 'function' var_0__2 = opt_o__i_name_k__p_ '(' var_0__4 = opt_o_parlist_p_ ')'
		var_0__6 = block 'end' { 
                $result = new FuncDef(_localctx.var_0__1, false, _localctx.var_0__2.result, _localctx.var_0__4.result,  _localctx.var_0__6.result);
            };
varargs
	returns[maybe<IToken> result]:
	',' var_0__2 = '...' { 
...
allow_empty_fields
	...
	| var_1__1 = nempty_fields { 
                $result = _localctx.var_1__1.result;
            };
field_list
	returns[List<table_field> result]:
	var_0__1 = allow_empty_fields { 
                $result = _localctx.var_0__1.result;
            };
optional_fieldsep:
	| var_0__1 = fieldsep
...
binop
	returns[Op<expr> result]:
	var_0__1 = 'or' { 
                $result = mkOperator<expr>((IToken) _localctx.var_0__1);
            }
	| var_1__1 = 'and' { 
                $result = mkOperator<expr>((IToken) _localctx.var_1__1);
            }
	| var_2__1 = '<' { 
                $result = mkOperator<expr>((IToken) _localctx.var_2__1);
            }
	| var_3__1 = '>' { 
                $result = mkOperator<expr>((IToken) _localctx.var_3__1);
            }
	| var_4__1 = '<=' { 
                $result = mkOperator<expr>((IToken) _localctx.var_4__1);
            }
	| var_5__1 = '>=' { 
                $result = mkOperator<expr>((IToken) _localctx.var_5__1);
            }
	| var_6__1 = '~=' { 
                $result = mkOperator<expr>((IToken) _localctx.var_6__1);
            }
	| var_7__1 = '==' { 
                $result = mkOperator<expr>((IToken) _localctx.var_7__1);
            }
	| var_8__1 = '|' { 
                $result = mkOperator<expr>((IToken) _localctx.var_8__1);
            }
	| var_9__1 = '~' { 
                $result = mkOperator<expr>((IToken) _localctx.var_9__1);
            }
	| var_10__1 = '&' { 
                $result = mkOperator<expr>((IToken) _localctx.var_10__1);
            }
	| var_11__1 = '<<' { 
                $result = mkOperator<expr>((IToken) _localctx.var_11__1);
            }
	| var_12__1 = '>>' { 
                $result = mkOperator<expr>((IToken) _localctx.var_12__1);
            }
	| var_13__1 = '..' { 
                $result = mkOperator<expr>((IToken) _localctx.var_13__1);
            }
	| var_14__1 = '+' { 
                $result = mkOperator<expr>((IToken) _localctx.var_14__1);
            }
	| var_15__1 = '-' { 
                $result = mkOperator<expr>((IToken) _localctx.var_15__1);
            }
	| var_16__1 = '*' { 
                $result = mkOperator<expr>((IToken) _localctx.var_16__1);
            }
	| var_17__1 = '/' { 
                $result = mkOperator<expr>((IToken) _localctx.var_17__1);
            }
	| var_18__1 = '//' { 
                $result = mkOperator<expr>((IToken) _localctx.var_18__1);
            }
	| var_19__1 = '%' { 
                $result = mkOperator<expr>((IToken) _localctx.var_19__1);
            };
